...
np.savetxt('mv_gaussian/low_dim_w_learnable_summary_stats/data/post_samples_analytical_' + str(dim) + '_' + str(seed) + '_' +
...
for i in range(N_test_obs_data):
    x_test_obs_data[i, :] = conj_model.sample().flatten()

np.savetxt('mv_gaussian/low_dim_w_learnable_summary_stats/data/x_o_samples_true_' + str(dim) + '_' + str(seed) +
...
np.savetxt('mv_gaussian/low_dim_w_learnable_summary_stats/data/x__samples_prior_pred_' + str(dim) + '_' + str(seed) +
...
np.savetxt('mv_gaussian/low_dim_w_learnable_summary_stats/data/x_samples_post_pred_' + str(dim) + '_' + str(seed) +
