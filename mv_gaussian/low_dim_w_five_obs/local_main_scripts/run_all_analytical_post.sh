...
do
  ...
  python /home/samuel/Documents/projects/'seq posterior approx w nf'/'seq posterior approx w nf dev'/mv_gaussian/low_dim_w_five_obs/run_script_analytical_post.py 0 2 $seed 10
  ((seed++))
done
