...
np.savetxt('mv_gaussian/low_dim_w_five_obs/data/post_samples_analytical_' + str(dim) + '_' + str(seed) + '_' +
...
np.savetxt('mv_gaussian/low_dim_w_five_obs/data/x_o_samples_true_' + str(dim) + '_' + str(seed) +
...
np.savetxt('mv_gaussian/low_dim_w_five_obs/data/x__samples_prior_pred_' + str(dim) + '_' + str(seed) +
...
np.savetxt('mv_gaussian/low_dim_w_five_obs/data/x_samples_post_pred_' + str(dim) + '_' + str(seed) +
